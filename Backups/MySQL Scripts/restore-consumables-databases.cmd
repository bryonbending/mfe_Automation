...
SET LOGFILE=F:\MySQL51Backup\restore-consumables-databases-log_%logDateTime%.txt
...
FOR /F "delims=" %%I IN ('DIR F:\MySQL51Backup\MySQL51_consumables_databases_*.sql /A-D /B /O-D /TW') DO (SET NewestFile=%%I & GOTO FoundFile)
    :FoundFile
